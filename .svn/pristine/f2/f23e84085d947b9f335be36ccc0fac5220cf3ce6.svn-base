namespace DELFI_WHM.NET.DELFI_User_Control
{
    partial class BSCEmisThanhPho
    {
        ...
        private void InitializeComponent()
        {
            ...
            new DevExpress.XtraEditors.Controls.LookUpColumnInfo("MaTinhThanhPho", "Mã", 70, DevExpress.Utils.FormatType.None, "", true, DevExpress.Utils.HorzAlignment.Center),
            new DevExpress.XtraEditors.Controls.LookUpColumnInfo("TenTinhThanhPho", 150, "Tỉnh - Thành phố")});
            this.lookUpEditValue.Properties.DisplayMember = "TenTinhThanhPho";
            this.lookUpEditValue.Properties.NullText = "Tỉnh - Thành phố";
            this.lookUpEditValue.Properties.PopupSizeable = false;
            this.lookUpEditValue.Properties.PopupWidth = 340;
            this.lookUpEditValue.Properties.ValueMember = "MaTinhThanhPho";
            ...
            this.lblCaption.Text = "Tỉnh - Thành phố";
            // 
            // BSCEmisThanhPho
            // 
