...
{
    public partial class BSCEmisKhoaHoc : UserControl
    {
        public BSCEmisKhoaHoc()
        {
            InitializeComponent();
            ...
            //DataTable dtVal = cnn.SelectRows("Select * from DM_KhoaHoc");
            //lookUpEditValue.DataBindings.Add("EditValue", dtVal, "MaKhoaHoc");
