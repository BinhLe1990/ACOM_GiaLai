namespace BSC_HRM.NET.NhanSu
{
    partial class frmQuaTrinhKyLuat
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txtSoThangKhongTangLuong = new BSC_HRM.NET.BSC_User_Control.uTextBox();
            ...
            this.dtpNgayKyLuat = new BSC_HRM.NET.BSC_User_Control.uDateTimePicker();
        ...
        private BSC_HRM.NET.BSC_User_Control.uDateTimePicker dtpNgayKyLuat;
        ...
        private BSC_HRM.NET.BSC_User_Control.uTextBox txtSoThangKhongTangLuong;
    }
}