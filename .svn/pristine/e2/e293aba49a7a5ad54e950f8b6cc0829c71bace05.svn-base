namespace DELFI_WHM.NET.ThamSoSQL
{
    partial class frmPopupNhapThamSo
    {
        ...
        {
            this.txtDuongDan = new DELFI_WHM.NET.DELFI_User_Control.uTextBox();
            this.cbxNhomDanhMuc = new DELFI_WHM.NET.DELFI_User_Control.uComboBox();
        ...
        public DELFI_WHM.NET.DELFI_User_Control.uTextBox txtDuongDan;
        public DELFI_WHM.NET.DELFI_User_Control.uComboBox cbxNhomDanhMuc;
    }
}