namespace BSC_HRM.NET.NhanSu
{
    partial class frmVanBangChungChi
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.cboVanBang = new BSC_HRM.NET.BSC_User_Control.uComboBox();
            this.txtLoaiBang = new BSC_HRM.NET.BSC_User_Control.uTextBox();
            this.txtSoBang = new BSC_HRM.NET.BSC_User_Control.uTextBox();
            this.txtXepLoai = new BSC_HRM.NET.BSC_User_Control.uTextBox();
            this.txtNoiCap = new BSC_HRM.NET.BSC_User_Control.uTextBox();
            this.dtpNgayCap = new BSC_HRM.NET.BSC_User_Control.uDateTimePicker();
        ...
        private BSC_HRM.NET.BSC_User_Control.uDateTimePicker dtpNgayCap;
        private System.Windows.Forms.ImageList IML;
        private BSC_HRM.NET.BSC_User_Control.uTextBox txtNoiCap;
        private BSC_HRM.NET.BSC_User_Control.uComboBox cboVanBang;
        private BSC_HRM.NET.BSC_User_Control.uTextBox txtLoaiBang;
        private BSC_HRM.NET.BSC_User_Control.uTextBox txtXepLoai;
        private BSC_HRM.NET.BSC_User_Control.uMemoEdit txtGhiChu;
        private BSC_HRM.NET.BSC_User_Control.uTextBox txtSoBang;
    }
}