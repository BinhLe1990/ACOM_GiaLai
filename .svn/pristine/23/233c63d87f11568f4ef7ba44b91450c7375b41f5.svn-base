namespace DELFI_WHM.NET.Luong
{
    partial class frmSoLuong
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txtGiamTruChoPhuThuoc = new DELFI_WHM.NET.DELFI_User_Control.uTextBox();
            this.txtGiamTruChoBanThan = new DELFI_WHM.NET.DELFI_User_Control.uTextBox();
            this.txtKinhPhiCongDoan_Truong = new DELFI_WHM.NET.DELFI_User_Control.uTextBox();
            this.txtBaoHiemThatNghiep_Truong = new DELFI_WHM.NET.DELFI_User_Control.uTextBox();
            this.txtBaoHiemYTe_Truong = new DELFI_WHM.NET.DELFI_User_Control.uTextBox();
            this.txtBaoHiemXaHoi_Truong = new DELFI_WHM.NET.DELFI_User_Control.uTextBox();
            this.txtKinhPhiCongDoan = new DELFI_WHM.NET.DELFI_User_Control.uTextBox();
            this.txtBaoHiemThatNghiep = new DELFI_WHM.NET.DELFI_User_Control.uTextBox();
            this.txtBaoHiemYTe = new DELFI_WHM.NET.DELFI_User_Control.uTextBox();
            this.txtBHXH = new DELFI_WHM.NET.DELFI_User_Control.uTextBox();
            this.txtPhuCapChiTieuNoiBo = new DELFI_WHM.NET.DELFI_User_Control.uTextBox();
            this.txtPhuCapThemGio = new DELFI_WHM.NET.DELFI_User_Control.uTextBox();
            this.txtPhuCapUuDai = new DELFI_WHM.NET.DELFI_User_Control.uTextBox();
            this.txtLuongCoBan = new DELFI_WHM.NET.DELFI_User_Control.uTextBox();
        ...
        private DELFI_WHM.NET.DELFI_User_Control.uTextBox txtLuongCoBan;
        private DELFI_WHM.NET.DELFI_User_Control.uTextBox txtPhuCapUuDai;
        private DELFI_WHM.NET.DELFI_User_Control.uTextBox txtPhuCapThemGio;
        private DevExpress.XtraEditors.SplitContainerControl spMain;
        private DevExpress.XtraEditors.GroupControl groupControl1;
        private DELFI_WHM.NET.DELFI_User_Control.uTextBox txtBaoHiemThatNghiep;
        private DELFI_WHM.NET.DELFI_User_Control.uTextBox txtBaoHiemYTe;
        private DELFI_WHM.NET.DELFI_User_Control.uTextBox txtBHXH;
        private DELFI_WHM.NET.DELFI_User_Control.uTextBox txtKinhPhiCongDoan;
        private DELFI_WHM.NET.DELFI_User_Control.uTextBox txtGiamTruChoPhuThuoc;
        private DELFI_WHM.NET.DELFI_User_Control.uTextBox txtGiamTruChoBanThan;
        private DELFI_WHM.NET.DELFI_User_Control.uTextBox txtPhuCapChiTieuNoiBo;
        private DELFI_WHM.NET.DELFI_User_Control.uTextBox txtKinhPhiCongDoan_Truong;
        private DELFI_WHM.NET.DELFI_User_Control.uTextBox txtBaoHiemThatNghiep_Truong;
        private DELFI_WHM.NET.DELFI_User_Control.uTextBox txtBaoHiemYTe_Truong;
        private DELFI_WHM.NET.DELFI_User_Control.uTextBox txtBaoHiemXaHoi_Truong;
