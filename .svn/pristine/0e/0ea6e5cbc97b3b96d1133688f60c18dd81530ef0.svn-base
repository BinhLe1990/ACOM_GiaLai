namespace DELFI_WHM.NET.DELFI_User_Control
{
    partial class BSCEmisTonGiao
    {
        ...
        private void InitializeComponent()
        {
            ...
            new DevExpress.XtraEditors.Controls.LookUpColumnInfo("MaTonGiao", "Mã", 70, DevExpress.Utils.FormatType.None, "", true, DevExpress.Utils.HorzAlignment.Center),
            new DevExpress.XtraEditors.Controls.LookUpColumnInfo("TenTonGiao", 150, "Tôn giáo")});
            this.lookUpEditValue.Properties.DisplayMember = "MaTonGiao";
            this.lookUpEditValue.Properties.NullText = "Tôn giáo";
            this.lookUpEditValue.Properties.PopupSizeable = false;
            this.lookUpEditValue.Properties.PopupWidth = 340;
            this.lookUpEditValue.Properties.ValueMember = "TenTonGiao";
