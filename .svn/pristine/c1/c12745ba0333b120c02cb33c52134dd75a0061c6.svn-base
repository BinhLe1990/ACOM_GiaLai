namespace DELFI_WHM.NET.Luong
{
    partial class frmChamCongThang
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.spinThang = new DELFI_WHM.NET.DELFI_User_Control.uSpinEdit();
            ...
            this.txtSoNgay = new DELFI_WHM.NET.DELFI_User_Control.uTextBox();
        ...
        private DELFI_WHM.NET.DELFI_User_Control.uSpinEdit spinThang;
        ...
        private DELFI_WHM.NET.DELFI_User_Control.uTextBox txtSoNgay;
