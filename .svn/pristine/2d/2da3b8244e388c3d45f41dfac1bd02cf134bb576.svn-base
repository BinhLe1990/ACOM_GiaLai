namespace BSC_HRM.NET.NhanSu
{
    partial class frmQuaTrinhDaoTao
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txtChiPhi = new BSC_HRM.NET.BSC_User_Control.uTextBox();
            this.txtSoBuoi = new BSC_HRM.NET.BSC_User_Control.uTextBox();
            this.txtKetQua = new BSC_HRM.NET.BSC_User_Control.uTextBox();
            this.txtDiaDiem = new BSC_HRM.NET.BSC_User_Control.uTextBox();
            this.txtNoiDung = new BSC_HRM.NET.BSC_User_Control.uTextBox();
        ...
        private BSC_HRM.NET.BSC_User_Control.uTextBox txtChiPhi;
        private BSC_HRM.NET.BSC_User_Control.uTextBox txtSoBuoi;
        private BSC_HRM.NET.BSC_User_Control.uTextBox txtKetQua;
        private BSC_HRM.NET.BSC_User_Control.uTextBox txtDiaDiem;
        private BSC_HRM.NET.BSC_User_Control.uTextBox txtNoiDung;
    }
}