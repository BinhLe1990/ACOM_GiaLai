namespace DELFI_WHM.NET.NhanSu
{
    partial class frmTongHopQuaTrinh
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.uFind1 = new DELFI_WHM.NET.DELFI_User_Control.uFind();
            this.btnInDanhSach = new DevExpress.XtraEditors.SimpleButton();
            this.btnThoat = new DevExpress.XtraEditors.SimpleButton();
            this.cboQuaTrinh = new DELFI_WHM.NET.DELFI_User_Control.uComboBox();
            ...
            this.uFind1.uClick += new DELFI_WHM.NET.DELFI_User_Control.uFind.EventHandler(this.uFind1_uClick);
            // 
            // btnInDanhSach
            // 
        ...
        private DELFI_WHM.NET.DELFI_User_Control.uFind uFind1;
        private DevExpress.XtraEditors.SimpleButton btnInDanhSach;
        private DevExpress.XtraEditors.SimpleButton btnThoat;
        private DELFI_WHM.NET.DELFI_User_Control.uComboBox cboQuaTrinh;
