namespace DELFI_WHM.NET.HeThong.FrHT
{
    partial class frmRestore
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txtFileDir = new DELFI_WHM.NET.DELFI_User_Control.uTextBox();
            this.btnBrowse = new DevExpress.XtraEditors.SimpleButton();
            this.txtPass = new DELFI_WHM.NET.DELFI_User_Control.uTextBox();
        ...
        private DELFI_WHM.NET.DELFI_User_Control.uTextBox txtFileDir;
        private DevExpress.XtraEditors.SimpleButton btnBrowse;
        private DELFI_WHM.NET.DELFI_User_Control.uTextBox txtPass;
