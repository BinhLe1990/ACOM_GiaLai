...
{
    public partial class frm_BC_KhoaBarCode : DevExpress.XtraEditors.XtraForm
    {
        DELFI_Class.DELFIConnection cnn = new DELFI_WHM.NET.DELFI_Class.DELFIConnection(Program.sConnection);
        string Tungay, Denngay;
        
        public frm_BC_KhoaBarCode()
        {
            InitializeComponent();
        }
        ...
        private void frm_BC_KhoaBarCode_Load(object sender, EventArgs e)
        {
