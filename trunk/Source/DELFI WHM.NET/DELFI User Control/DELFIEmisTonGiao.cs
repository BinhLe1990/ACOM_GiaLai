...
{
    public partial class BSCEmisTonGiao : UserControl
    {
        public BSCEmisTonGiao()
        {
            InitializeComponent();
            ...
            //DataTable dtVal = cnn.SelectRows("Select * from DM_TonGiao");
            //lookUpEditValue.DataBindings.Add("EditValue", dtVal, "MaTonGiao");
