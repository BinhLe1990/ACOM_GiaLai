...
{
    public partial class BSCEmisDanToc : UserControl
    {
        public BSCEmisDanToc()
        {
            InitializeComponent();
            ...
            //DataTable dtVal = cnn.SelectRows("Select * from DM_DanToc");
            //lookUpEditValue.DataBindings.Add("EditValue", dtVal, "MaDanToc");
