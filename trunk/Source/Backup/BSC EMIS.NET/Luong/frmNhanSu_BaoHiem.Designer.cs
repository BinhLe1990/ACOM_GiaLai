namespace BSC_HRM.NET.Luong
{
    partial class frmNhanSu_BaoHiem
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txtTyLeDong = new BSC_HRM.NET.BSC_User_Control.uTextBox();
            this.txtDenThangNam = new BSC_HRM.NET.BSC_User_Control.uTextBox();
            this.txtTuThangNam = new BSC_HRM.NET.BSC_User_Control.uTextBox();
            ...
            this.cbxDot = new BSC_HRM.NET.BSC_User_Control.uComboBox();
        ...
        private BSC_HRM.NET.BSC_User_Control.uComboBox cbxDot;
        ...
        private BSC_HRM.NET.BSC_User_Control.uTextBox txtTyLeDong;
        private BSC_HRM.NET.BSC_User_Control.uTextBox txtDenThangNam;
        private BSC_HRM.NET.BSC_User_Control.uTextBox txtTuThangNam;
    }
}