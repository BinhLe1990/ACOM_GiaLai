namespace BSC_HRM.NET.BSC_User_Control
{
    partial class frmDefineCondition
    {
        ...
        {
            this.cbxPhepSoSanh = new BSC_HRM.NET.BSC_User_Control.BSCComboBox();
            this.txtKetQua = new BSC_HRM.NET.BSC_User_Control.uMemoEdit();
            ...
            this.txtDate = new BSC_HRM.NET.BSC_User_Control.uDateTimePicker();
            this.cbxGiaTri = new BSC_HRM.NET.BSC_User_Control.uComboBox();
            this.SuspendLayout();
            // 
            // cbxPhepSoSanh
            // 
