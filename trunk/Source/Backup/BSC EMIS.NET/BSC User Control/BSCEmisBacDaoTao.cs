...
{
    public partial class BSCEmisBacDaoTao : UserControl
    {
        public BSCEmisBacDaoTao()
        {
            InitializeComponent();
            ...
            //DataTable dtVal = cnn.SelectRows("Select * from DM_BacDaoTao");
            //lookUpEditValue.DataBindings.Add("EditValue", dtVal, "MaBacDaoTao");
