namespace BSC_HRM.NET.HeThong.FrND
{
    partial class frmNhatKyNguoiDung
    {
        ...
        {
            this.txtTuNgay = new BSC_HRM.NET.BSC_User_Control.uDateTimePicker();
            this.txtDenNgay = new BSC_HRM.NET.BSC_User_Control.uDateTimePicker();
            this.cbxNguoiDung = new BSC_HRM.NET.BSC_User_Control.uComboBox();
            ...
            this.txtTuNgay.uDateTime = new System.DateTime(2010, 7, 22, 9, 22, 49, 453);
            ...
            this.txtDenNgay.uDateTime = new System.DateTime(2010, 7, 22, 9, 22, 51, 640);
        ...
        private BSC_HRM.NET.BSC_User_Control.uDateTimePicker txtTuNgay;
        private BSC_HRM.NET.BSC_User_Control.uDateTimePicker txtDenNgay;
        private BSC_HRM.NET.BSC_User_Control.uComboBox cbxNguoiDung;
