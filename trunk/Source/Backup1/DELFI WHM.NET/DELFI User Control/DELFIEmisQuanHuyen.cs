...
{
    public partial class BSCEmisQuanHuyen : UserControl
    {
        public BSCEmisQuanHuyen()
        {
            InitializeComponent();
            ...
            //DataTable dtVal = cnn.SelectRows("Select * from DM_QuanHuyen");
            //lookUpEditValue.DataBindings.Add("EditValue", dtVal, "MaQuanHuyen");
