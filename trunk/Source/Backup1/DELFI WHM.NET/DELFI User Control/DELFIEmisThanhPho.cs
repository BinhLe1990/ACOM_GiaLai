...
{
    public partial class BSCEmisThanhPho : UserControl
    {
        public BSCEmisThanhPho()
        {
            InitializeComponent();
            ...
            //DataTable dtVal = cnn.SelectRows("Select * from DM_TinhThanhPho");
            //lookUpEditValue.DataBindings.Add("EditValue", dtVal, "MaTinhThanhPho");
