...
{
    partial class BSCEmisQuanHuyen
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
            ...
            new DevExpress.XtraEditors.Controls.LookUpColumnInfo("MaQuanHuyen", "Mã", 70, DevExpress.Utils.FormatType.None, "", true, DevExpress.Utils.HorzAlignment.Center),
            new DevExpress.XtraEditors.Controls.LookUpColumnInfo("TenQuanHuyen", 150, "Quận - Huyện")});
            this.lookUpEditValue.Properties.DisplayMember = "TenQuanHuyen";
            this.lookUpEditValue.Properties.NullText = "Quận - Huyện";
            this.lookUpEditValue.Properties.PopupSizeable = false;
            this.lookUpEditValue.Properties.PopupWidth = 340;
            this.lookUpEditValue.Properties.ValueMember = "MaQuanHuyen";
            ...
            this.lblCaption.Text = "Quận - Huyện";
            // 
            // BSCEmisQuanHuyen
            // 
