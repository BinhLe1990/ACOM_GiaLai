...
{
    public partial class BSCEmisLoaiDaoTao : UserControl
    {
        public BSCEmisLoaiDaoTao()
        {
            InitializeComponent();
            ...
            //DataTable dtVal = cnn.SelectRows("Select * from DM_LoaiDaoTao");
            //lookUpEditValue.DataBindings.Add("EditValue", dtVal, "MaLoaiDaoTao");
